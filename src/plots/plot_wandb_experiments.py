#!/usr/bin/env python3
"""
Script to plot grouped W&B experiment results with W&B-style visualization.

This script creates publication-quality plots comparing different algorithms
on the same environment, with options for EMA smoothing and opacity control
similar to W&B's native plotting interface.

Usage:
    python plot_wandb_experiments.py --groups "pbsac_HalfCheetah-v4,sac_HalfCheetah-v4" --metric "rollout/episodic_return"
    python plot_wandb_experiments.py --data-dir "./wandb_tensorboards" --groups "pbac_Ant-v4" --smooth 0.9
"""
...
class WandbStylePlotter:
    ...
    def __init__(self, data_dir: str = "wandb_tensorboards"):
        ...
        self.color_palette = [
            "#ec3091", "#3c9ae6", "#056A68", '#fe5901', '#ffc100',
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Plot W&B-style experiment comparisons from downloaded tensorboard data",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Compare PBSAC and SAC on HalfCheetah
  python plot_wandb_experiments.py --groups "pbsac_HalfCheetah-v4,sac_HalfCheetah-v4"

  # Plot with heavy smoothing and hide raw data
  python plot_wandb_experiments.py --groups "pbac_Ant-v4" --smooth 0.9 --no-raw

  # Custom metric and save plot
  python plot_wandb_experiments.py --groups "pbsac_Hopper-v4" --metric "train/actor_loss" --save "actor_loss.png"

  # Limit x-axis to first 500k steps
  python plot_wandb_experiments.py --groups "pbsac_HalfCheetah-v4,sac_HalfCheetah-v4" --max-steps 500000

  # List available groups and metrics
  python plot_wandb_experiments.py --list-groups
  python plot_wandb_experiments.py --list-metrics "pbsac_HalfCheetah-v4"
        """
    )

    parser.add_argument(
        '--groups',
        help='Comma-separated list of group names (e.g., "pbsac_HalfCheetah-v4,sac_HalfCheetah-v4")'
    )
